...
function Interview({ questionData }) {
    const gridHeadings = ['Accenture', 'Athena Health', 'Amazon', 'Bank Of America', 'Capgemini', 'D. E. Shaw', 'IBM', 'Genpact', 'KPIT', 'Mahindra & Mahindra', 'Maersk', 'Mivada', 'Movate', 'Oracle', 'Pepsico', 'Persistent Systems', 'Publicis Sapient', 'PWC', 'Salesforce', 'State Street', 'Sify', 'Tech Mahinda', 'Verizon', 'VISA', 'Wabtec', 'Optum', 'Target', 'Qualizeal', 'Factset', 'OpenText', 'UST'];
        ...
        <div className='container mt-3'>
            ...
            {data.interview ?
                ...
                <div className='bg-light p-4 rounded'>
                    ...
                    <div className='mt-2'>
        {data.interview.text.split('\n').map((line, index) => (
            <span key={index}>
                {line.includes('http') ? (
                                    <a href={line} target='_blank' rel='noopener noreferrer' style={{ color: 'blue' }}>
                                        {line}
                                    </a>
                                ) : (
                                    line
